...
public class LRUCache {
	public static void main(String[] args) {
		LRUCacheImpl lruCacheImpl = new LRUCacheImpl(2);
		lruCacheImpl.put(1, 1);
		lruCacheImpl.put(2, 2);
		System.out.println(lruCacheImpl.get(1));
		lruCacheImpl.put(3, 3);
		System.out.println(lruCacheImpl.get(2));
		lruCacheImpl.put(4, 4);
		System.out.println(lruCacheImpl.get(3));
		lruCacheImpl.get(4);
	}
}
